package com.segura.fragmentos.core;
...
import com.segura.fragmentos.gui.MainActivity;

import dmax.dialog.SpotsDialog;

public class MissController {
    private static MissController instance = null;
    ...
    private MissController() {
    }

    public static MissController Instance() {
        if (instance == null)
            instance = new MissController();
        return instance;
    }
